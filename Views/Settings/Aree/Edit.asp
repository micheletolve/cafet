...
<div class="container">
    ...
    <blockquote class="blockquote"><i class="fa fa-quote-left fa-1x" aria-hidden="true"></i> Modifica area <%=Html.Encode(ModelAree.Area) %>. <i class="fa fa-quote-right fa-1x" aria-hidden="true"></i></blockquote>

    <form action="?controller=Aree&action=EditPost" method="POST" id="EditPost">

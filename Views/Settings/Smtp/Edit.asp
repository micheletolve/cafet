...
<div class="container">
    ...
    <blockquote class="blockquote"><i class="fa fa-quote-left fa-1x" aria-hidden="true"></i> Modifica server smtp <%=Html.Encode(ModelSmtp.Nome) %> per l'invio delle notifiche. <i class="fa fa-quote-right fa-1x" aria-hidden="true"></i></blockquote>

    <form action="?controller=Smtp&action=EditPost" method="POST" id="EditPost">

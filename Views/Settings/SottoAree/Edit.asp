...
<div class="container">
    ...
    <blockquote class="blockquote"><i class="fa fa-quote-left fa-1x" aria-hidden="true"></i> Modifica sottoarea <%=Html.Encode(ModelSottoaree.Sottoarea) %>. <i class="fa fa-quote-right fa-1x" aria-hidden="true"></i></blockquote>

    <form action="?controller=Sottoaree&action=EditPost" method="POST" id="EditPost">
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <%=Html.DropDownList("Area_id", ModelSottoaree.Area_Id, new AreeHelper.SelectAll().Items, "Id", "Area")%>
            </div>
        </div>
        ...
        <div class="form-row">            
            <div class="form-group col-md-10">
                ...
                <%=Html.TextBox("Descrizione", ModelSottoaree.Descrizione, "Descrizione sottoarea")%>
            </div>
        </div>

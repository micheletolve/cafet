...
<div class="container">
    ...
    <form action="?controller=ScadenzeBudget&action=CreatePost" method="POST" id="CreatePost">

        <%=Html.Hidden("Id", 0) %>

        <div class="form-row">
            <div class="form-group col-md-4">
                <label for="anno_riferimento" class="col-form-label">Anno di riferimento (es. 1997)</label>
                <%=Html.NumberReq("anno_riferimento", ModelScadenzeBudget.Anno_riferimento)%>
            </div>
        </div>

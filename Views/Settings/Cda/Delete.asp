...
<div class="container">
    ...
    <blockquote class="blockquote"><i class="fa fa-quote-left fa-1x" aria-hidden="true"></i> Sposta nel cestino i seguenti dati  <i class="fa fa-quote-right fa-1x" aria-hidden="true"></i></blockquote>
    ...
    <form action="?controller=TeamInterno&action=DeletePost" method="POST" id="DeletePost">

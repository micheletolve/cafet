...
<div class="container">
  ...
  <blockquote class="blockquote"><i class="fa fa-quote-left fa-1x" aria-hidden="true"></i> Modifica voce menu di secondo livello sotto il menu <i class="<%=ModelMenu.Fa_icon%>"></i><%=ModelMenu.Label%> <i class="fa fa-quote-right fa-1x" aria-hidden="true"></i></blockquote>
  ...
  <form action="?controller=MenuChild&action=EditPost" method="POST" id="EditPost">

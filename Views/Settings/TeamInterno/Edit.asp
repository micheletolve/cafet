...
<div class="container">
    ...
    <blockquote class="blockquote"><i class="fa fa-quote-left fa-1x" aria-hidden="true"></i> Modifica membro del team interno <i class="fa fa-quote-right fa-1x" aria-hidden="true"></i></blockquote>

    <form action="?controller=TeamInterno&action=EditPost" method="POST" id="EditPost">    
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <%=Html.DropDownList("utente_id", ModelTeamInterno.Utente_id, new UserHelper.SelectAll().Items, "Id", "NomeCompleto")%>
            </div>
            
            <div class="form-group col-md-6">
                <label for="ruoloti_id" class="col-form-label">Ruolo team interno</label>
                <%=Html.DropDownList("ruoloti_id", ModelTeamInterno.Ruoloti_id, new RoleTeamInternoHelper.SelectAll().Items, "Id", "Descrizione")%>
            </div>
        </div>        

...
<div class="container">
    ...
    <blockquote class="blockquote"><i class="fa fa-quote-left fa-1x" aria-hidden="true"></i> Sposta nel cestino <%=Html.Encode(ModelRilevanze.Rilevanza) %>  <i class="fa fa-quote-right fa-1x" aria-hidden="true"></i></blockquote>
    ...
    <form action="?controller=Rilevanze&action=DeletePost" method="POST" id="DeletePost">

...
<div class="container">
    ...
    <blockquote class="blockquote"><i class="fa fa-quote-left fa-1x" aria-hidden="true"></i> Eliminazione definitiva stao di investimento <%=Html.Encode(ModelRilevanze.Rilevanza) %>  <i class="fa fa-quote-right fa-1x" aria-hidden="true"></i></blockquote>
    ...
    <div class="row">
        <table class="table table-hover">
            <tr>
                <th class="detail"><label for="Rilevanza" class="col-form-label">Rilevanza investimento</label></th>
                <td class="detail"><%=Html.Encode(ModelRilevanze.Rilevanza) %></td>
            </tr>            
        </table>
    </div>

    <form action="?controller=Rilevanze&action=ErasePost" method="POST" id="ErasePost">

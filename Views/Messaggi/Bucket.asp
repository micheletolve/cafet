				...
				<div class="box box-solid">
					...
					<div class="box-body no-padding">
						<ul class="nav nav-pills flex-column">
								...
								<li class="active"><a href="?Controller=Messaggi&Action=Bucket"><i class="fas fa-trash"></i> Cestino <span class="badge badge-primary pull-right"><% If (countElementTrash > 0) Then Response.Write(countElementTrash) End If %></span></a></li>
									...
									<tr>
										...
										<td class="btn-group open">
											...
											<ul class="dropdown-menu">
													...
													<li ><%=Html.ActionLinkFa("fa fa-recycle fa-fw"," Ripristina messaggio", "Messaggi", "UnDelete" , "id=" + CStr(obj.Id)) %></li>
											</ul>
										</td>
									</tr>
									<% Next %>

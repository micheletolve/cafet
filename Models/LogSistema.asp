...
' 
' This files defines the LogSistema model 
'
...
class LogSistemaHelper
  ...
  private sub Class_Initialize()
    selectSQL = " SELECT * FROM [LogSistema] ORDER BY created_at DESC"
  end sub
 ...
 'public Functions
  ...
  public function Insert(log)
      Dim strSQL 
      strSQL=   " INSERT INTO [LogSistema] (user_id, logging, created_at) VALUES ({0}, '{1}', '{2}') "
